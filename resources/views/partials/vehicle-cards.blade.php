@foreach ($vehicles as $vehicle)
    @php
        ...
        $column = $viewMode === 'list' ? 'col-xl-6 col-lg-12' : 'col-xl-3 col-lg-4 col-sm-6';
    @endphp
    <div class="{{ $column }}">
        <div class="feature-list-1 {{ $viewMode === 'list' ? 'list' : '' }}">
            <div class="box-icon">
            ...
            <div class="car-content">
                <div class="media-body">
                    ...
                    @if ($vehicle->trim)
                        <p class="box-text"><span>Trim:</span> {{ $vehicle->trim }}</p>
                    @endif
                </div>
