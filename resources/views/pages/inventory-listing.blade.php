...
<html class="no-js" lang="zxx">
  <!-- Mirrored from html.themehour.net/kars/demo/inventory-listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Sep 2026 10:16:17 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>
      Konastone Autos and Imports - Inventory Listing
    </title>
    <meta name="author" content="Konastone Autos and Imports" />
    <meta
      name="description"
      content="Browse vehicles available from Konastone Autos and Imports."
    />
    <meta name="keywords" content="Konastone Autos and Imports, vehicle inventory" />
    ...
    />
    <link
      href="../../../fonts.googleapis.com/css2a956.css?family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&amp;family=Play:wght@400;700&amp;display=swap"
      rel="stylesheet"
    />
          ...
          <div class="widget_shopping_cart_content">
            <ul class="woocommerce-mini-cart cart_list product_list_widget">
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="{{ asset('assets/img/product/product_1_1.png') }}"
                    alt="Cart Image"
                  />Bosco Apple Fruit</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="{{ asset('assets/img/product/product_1_2.png') }}"
                    alt="Cart Image"
                  />Green Cauliflower</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="{{ asset('assets/img/product/product_1_3.png') }}"
                    alt="Cart Image"
                  />Mandarin orange</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="{{ asset('assets/img/product/product_1_4.png') }}"
                    alt="Cart Image"
                  />Shallot Red onion</a
                >
                <span class="quantity"
              ...
              <li class="woocommerce-mini-cart-item mini_cart_item">
                ...
                <a href="#"
                  ><img
                    src="{{ asset('assets/img/product/product_1_5.png') }}"
                    alt="Cart Image"
                  />Sour Red Cherry</a
                >
                <span class="quantity"
        ...
        <div class="th-mobile-menu">
          <ul>
            <li class="menu-item-has-children active">
              <a href="{{ url('/') }}">Home</a>
              <ul class="sub-menu">
                <li><a href="{{ url('/') }}">Home Car Dealership</a></li>
            ...
            <li class="menu-item-has-children">
              ...
              <ul class="sub-menu">
                ...
                <li>
                  <a href="inventory-left-sidebar.html"
                    >Inventory Left Sidebar</a
                  >
                </li>
                <li>
                  <a href="inventory-right-sidebar.html"
                    >Inventory Right Sidebar</a
                  >
                </li>
              ...
              <div class="header-links">
                <ul>
                  <li>
                    ...
                    <a href="{{ config('dealership.contact.map_url') }}"
                      >{{ config('dealership.contact.address') }}, {{ config('dealership.contact.city') }}</a
                    >
                  </li>
                  <li>
                    <i class="fa-regular fa-phone"></i>
                    <a href="tel:{{ config('dealership.contact.phone_formatted') }}">{{ config('dealership.contact.phone') }}</a>
                  </li>
                  <li>
                    <i class="fa-sharp fa-regular fa-envelope"></i>
                    <a href="mailto:{{ config('dealership.contact.email') }}">{{ config('dealership.contact.email') }}</a>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <li class="d-none d-md-inline-block lang-wrapper">
                    <div class="dropdown-link">
                      <a
                        ...
                        aria-expanded="false"
                        ><i class="fa-regular fa-globe"></i> English</a
                      >
                      <ul
                        class="dropdown-menu"
                      ...
                      >
                        <li>
                          <a href="#">English</a> <a href="#">German</a>
                          <a href="#">French</a> <a href="#">Italian</a>
                          <a href="#">Latvian</a>
                        </li>
                      </ul>
                    </div>
            ...
            <div class="row align-items-center justify-content-between">
                  ...
                  <ul>
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li>
                          <a href="dealership-details.html"
                            >Dealership Details</a
                          >
                        </li>
                      </ul>
                    </li>
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li><a href="{{ route('sell.car') }}">Sell a Car</a></li>
                        <li>
                          <a href="inventory-comparison.html"
                            >Inventory Comparison</a
                          >
                        </li>
                      </ul>
                    </li>
              ...
              <div class="col-auto d-none d-xl-block">
                <div class="header-button">
                  ...
                  <a href="{{ route('sell.car') }}" class="th-btn"
                    >Adding List <i class="fa-solid fa-circle-plus"></i
                  ></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-xl-3">
              <div class="widget footer-widget">
                ...
                <div class="th-widget-about">
                  <p class="about-text">
                    Dealerships allow customers to take vehicles for test drives
                    to experience how the car feels before making a purchase.
                  </p>
                  <div class="footer-call-wrap">
                    <div class="info-box">
                      <div class="info-contnt">
                        ...
                        <p class="info-box_text">
                          <a href="tel:{{ config('dealership.contact.phone_formatted') }}" class="info-box_link"
                            >{{ config('dealership.contact.phone') }}</a
                          >
                        </p>
                      </div>
                    </div>
                    <div class="info-box">
                      <div class="info-contnt">
                        ...
                        <p class="info-box_text">
                          <a href="mailto:{{ config('dealership.contact.email') }}" class="info-box_link"
                            >{{ config('dealership.contact.email') }}</a
                          >
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="th-social">
                    ...
                    ></a>
                    <a href="{{ config('dealership.contact.whatsapp_url') }}"
                  ...
                  <div class="recent-post">
                    ...
                    <div class="media-body">
                      <div class="recent-post-meta">
                        <a href="blog.html"
                          ><i class="fa-solid fa-calendar-days"></i> 10 Dec,
                          2025</a
                        >
                      </div>
                      <h4 class="post-title">
          ...
          <div class="row gy-2 align-items-center">
            <div class="col-md-12">
              <p class="copyright-text text-center">
                ...
                <a href="{{ url('/') }}">Konastone Autos and Imports</a>. All Rights Reserved.
              </p>
            </div>
          </div>
        </div>
