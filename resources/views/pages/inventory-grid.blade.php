...
@section('title', 'Inventory Grid | Konastone Autos and Imports')
@section('meta_description', 'Browse available vehicles in the inventory grid at Konastone Autos and Imports.')
@section('canonical', route('inventory.grid'))
@section('og_title', 'Inventory Grid | Konastone Autos and Imports')
@section('og_description', 'Browse available vehicles in the inventory grid at Konastone Autos and Imports.')
